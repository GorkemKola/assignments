...
public class ListAfter {
    /**
     * A Function that returns a String of the List of the Films that after a year
     *
     * @param films An ArrayList holding films
     * @param year  a parameter that allows the function to find the years after that year
     * @return String that will be added on output
     */
    public static String after(ArrayList<Film> films, int year) {
